		...
		private static function get_2fa_changes_array(): array {
			return array(
				...
				7813 => array(
					7813,
					WSAL_LOW,
					esc_html__( 'A WP 2FA user configured backup codes', 'wp-security-audit-log' ),
					__( 'Backup Codes were generated.', 'wp-security-audit-log' ),
					array(),
					Constants::wsaldefaults_build_links( array( 'EditUserLink' ) ),
					'2fa',
					'added',
				...
				7814 => array(
					7814,
					WSAL_MEDIUM,
					esc_html__( 'A WP 2FA user generated new backup codes', 'wp-security-audit-log' ),
					__( 'New backup codes were generated.', 'wp-security-audit-log' ),
					array(
						esc_html__( 'New hashed codes', 'wp-security-audit-log' ) => '%new_codes%',
						esc_html__( 'Old hashed codes', 'wp-security-audit-log' ) => '%old_codes%',
					),
					Constants::wsaldefaults_build_links( array( 'EditUserLink' ) ),
					'2fa',
					'updated',
				...
				7815 => array(
					7815,
					WSAL_MEDIUM,
					esc_html__( 'User used backup code for login', 'wp-security-audit-log' ),
					__( 'Backup code %used_backup_code% has been used. %codes_remaining% unused backup codes remaining.', 'wp-security-audit-log' ),
					array(),
					Constants::wsaldefaults_build_links( array( 'EditUserLink' ) ),
					'2fa',
					'removed',
				...
				7816 => array(
					7816,
					WSAL_HIGH,
					esc_html__( 'User has used last backup code for login', 'wp-security-audit-log' ),
					__( 'Backup code %used_backup_code% has been used. Backup codes has been depleted! %codes_remaining% backup codes remaining!', 'wp-security-audit-log' ),
					array(),
					Constants::wsaldefaults_build_links( array( 'EditUserLink' ) ),
					'2fa',
					'disabled',
				...
				7817 => array(
					7817,
					WSAL_MEDIUM,
					esc_html__( 'WP 2FA Secondary 2FA methods Backup codes option was modified', 'wp-security-audit-log' ),
					__( 'Changed the value of %changed_option%', 'wp-security-audit-log' ),
					array(
						esc_html__( 'Previous option', 'wp-security-audit-log' ) => '%old_value%',
						esc_html__( 'New option', 'wp-security-audit-log' ) => '%new_value%',
					),
					array(),
					'wp-2fa-settings',
					'modified',
