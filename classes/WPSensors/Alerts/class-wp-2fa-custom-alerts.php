		...
		private static function get_2fa_changes_array(): array {
			return array(
				...
				7815 => array(
					...
					__( 'One of backup codes has been used. %codes_remaining% unused backup codes remaining.', 'wp-security-audit-log' ),
					array(),
					Constants::wsaldefaults_build_links( array( 'EditUserLink' ) ),
					'2fa',
					'removed',
				...
				7816 => array(
					...
					__( 'Backup codes has been depleted! %codes_remaining% backup codes remaining!', 'wp-security-audit-log' ),
					array(),
					Constants::wsaldefaults_build_links( array( 'EditUserLink' ) ),
					'2fa',
					'disabled',
